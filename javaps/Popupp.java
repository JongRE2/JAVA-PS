...
//import handler.JFrameWindowClosingEventHandler;
//import handler.MemberShipActionListener;
////http://egloos.zum.com/windydh/v/10543406
...
//
//
//    public Popupp(JTable calcTable, MemberShipActionListener msal, int usedPoint, int usedCusNum, String tel,
//                  DefaultTableModel orderTableModel) {
//
//        super("금액");
...
//                        System.out.println("popupp3 호출하기전에 회원의 번호 : " + usedCusNum);
//                        System.out.println("popupp3 호출하기전에 회원이 사용한 포인트 : " + usedPoint);
//                        //change = total - cashMoney - sale; // 전체금액에서 현금, 포인트 뺀 돈
//                        pp = new Popupp3(calcTable, msal, orderTableModel, change,
//                                cashReceipt, tel);
//                        //pp.setSize(210, 350);
//                        pp.setSize(400, 300);
